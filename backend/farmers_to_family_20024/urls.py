"""farmers_to_family_20024 URL Configuration
...
admin.site.site_header = "Farmers to Family"
admin.site.site_title = "Farmers to Family Admin Portal"
admin.site.index_title = "Farmers to Family Admin"

# swagger
api_info = openapi.Info(
    title="Farmers to Family API",
    default_version="v1",
    description="API documentation for Farmers to Family App",
)
